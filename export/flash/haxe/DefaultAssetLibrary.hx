...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("axollib/images/color-logo.png", __ASSET__axollib_images_color_logo_png);
		type.set ("axollib/images/color-logo.png", AssetType.IMAGE);
		className.set ("axollib/images/color-stroke.png", __ASSET__axollib_images_color_stroke_png);
		type.set ("axollib/images/color-stroke.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "axollib/images/color-logo.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "axollib/images/color-stroke.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__axollib_images_color_logo_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__axollib_images_color_stroke_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("C:/Users/Tim/Documents/repos/axollib/assets/images/color-logo.png") #if display private #end class __ASSET__axollib_images_color_logo_png extends lime.graphics.Image {}
@:image("C:/Users/Tim/Documents/repos/axollib/assets/images/color-stroke.png") #if display private #end class __ASSET__axollib_images_color_stroke_png extends lime.graphics.Image {}
